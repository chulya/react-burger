...
export const IngredientsType = (props) => {
  ...
  return (
		<article className={`${ingredientsStyle.item} `} id={props.type}>
			<h2 className={`${ingredientsStyle.text} text text_type_main-medium pb-6 pt-2`}>{props.text}</h2>
...
IngredientsType.protoType = {
  type: PropTypes.arrayOf(ingredientType.isRequired),
	text: PropTypes.arrayOf(ingredientType.isRequired)
}
