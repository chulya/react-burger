...
export const IngredientsItem = (props) => {
	return (
    	...
    	<Counter count = {1} size = 'default' />
			<img className = {`${ingredientsItemStyle.image}`} src = {props.image} alt = {props.name} />
...
IngredientsItem.protoType = {
	image: PropTypes.arrayOf(ingredientType.isRequired),
  price: PropTypes.arrayOf(ingredientType.isRequired),
  name: PropTypes.arrayOf(ingredientType.isRequired)
}